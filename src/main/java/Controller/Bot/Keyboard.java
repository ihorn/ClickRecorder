...
public class Keyboard {
    ...
    /**
     * Type a string. Eache character is typed at a random time between 0 and
     * maxDelay.
     *
     * @param characters
     * @param maxDelay
     */
    public void type(CharSequence characters, int maxDelay) {
        int length = characters.length();
        if (characters.equals("Escape")) { // Escape button
            type('£');
            myRobot.delay(maxDelay);
            ...
            for (int i = 0; i < length; i++) {
                ...
                type(character);
                myRobot.delay(Bot.randInt(0, maxDelay));
            }
        }
    }
